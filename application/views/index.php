...
<head>
    ...
    <!-- Pastikan Anda mengganti versi_x.x.x dengan versi terbaru saat ini -->
    <script src="https://cdn.tiny.cloud/1/e6r2vw54l6yzdh50or7bp1e85sxgwo3hqcjdsvrvq6ikkr0j/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
    <!-- Chart.js -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#7109e0;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="<?= base_url('assets/img/'); ?>buru.png" alt="Logo" height="50" width="50">
                </div>
                <div class="sidebar-brand-text mx-3">E-Voting Desa Wanareja<sup></sup></div>
            </a>
            <!-- Divider -->
            ...
            <?php if ($this->session->userdata('level') == 'administrator') : ?>
                <!-- Nav Item - rt -->
                <li class="nav-item <?= isset($mRt) ? 'active' : ''; ?>">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="background-color:#840ced;">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-4 d-none d-lg-inline text-white text-uppercase">
