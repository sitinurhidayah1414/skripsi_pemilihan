...
class Calon extends CI_Controller
{
    ...
    public function proses_tambah()
    {
        ...
        if ($this->upload->do_upload('foto_calon')) {
            ...
            $data = [
                'rt_calon_kdes' => $this->input->post('rt_calon_kdes', true),
                'nik_calon_kdes' => $this->input->post('nik_calon_kdes', true),
                'calon_kdes' => $this->input->post('calon_kdes', true),
    ...
    public function proses_ubah()
    {
        if ($_FILES['foto_calon']['name'] == "") {
            $data = [
                'rt_calon_kdes' => $this->input->post('rt_calon_kdes', true),
                'rt_calon_wakdes' => $this->input->post('rt_calon_wakdes', true),
                'nik_calon_kdes' => $this->input->post('nik_calon_kdes', true),
                'visi_misi' => $this->input->post('visi_misi', true),
